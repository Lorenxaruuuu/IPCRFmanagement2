...
<div class="min-h-screen flex" x-data="{ showLogoutModal: false, showCreateAdminModal: false }">
    ...
    <aside class="fixed left-0 top-0 h-full w-64 bg-slate-900 text-white flex flex-col shadow-xl z-20">
        ...
        <nav class="flex-1 py-6 px-4 space-y-2">
            <a href="#" class="flex items-center gap-3 px-4 py-3 rounded-xl bg-blue-600/10 text-blue-400 font-semibold transition-all">
    ...
    <div class="ml-64 flex-1 flex flex-col min-w-0">
        ...
        <header class="bg-white border-b h-20 flex items-center justify-between px-8 sticky top-0 z-10 shadow-sm">
            <div>
                <h2 class="text-2xl font-bold text-slate-800">Superadmin Control Center</h2>
                <p class="text-xs text-slate-500 mt-0.5">Manage system access, approve credentials, and register administrators</p>
            </div>
